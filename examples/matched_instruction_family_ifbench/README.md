...
This is the bounded second-task design for Imp's instruction optimizers. It is
not launchable yet: `contract-draft.json` deliberately grants no network
...
```sh
python3 examples/matched_instruction_family_ifbench/build_data.py \

...
alias MatchedGepaMiproIFBenchGepa014.Contract
...
expected_commit =
  System.get_env("MATCHED_IFBENCH_GEPA014_EXPECTED_COMMIT") ||
    raise "MATCHED_IFBENCH_GEPA014_EXPECTED_COMMIT is required"

unless report.source_commit == expected_commit do
  raise "GEPA 0.1.4 successor launch commit drift: #{report.source_commit} != #{expected_commit}"
end

defmodule ImpOptimizerLifecycles.Ensemble do
  ...
  @artifacts %{
    bootstrap_few_shot:
      "examples/optimizer_lifecycles/exercised-classical/bootstrap-few-shot.parameters.json",
    signature_optimizer:
      "examples/optimizer_lifecycles/exercised-instruction/signature_optimizer.parameters.json",
    infer_rules: "examples/optimizer_lifecycles/exercised-instruction/infer_rules.parameters.json"
  }

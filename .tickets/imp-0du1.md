...
**2026-08-22T19:25:00Z**

Completed the reviewed stable-authority cutover to exact DSPy 3.3.1 commit `638e155c`, tag object `753ab03d`, and the independently materialized 157-file wheel tree digest `b9364d08…`. The executable 73-page API inventory is content-bound by its computed hash rather than an opaque decorative digest; historical 3.2.1/3.3.0b1 differentials retain their original treatment identities under the renamed historical optimizer-contract field. The generated conformance map and public DSPy-user guide now describe the current source truth.

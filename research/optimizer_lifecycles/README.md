...
mix run research/optimizer_lifecycles/classical.exs
```
...
mix run research/optimizer_lifecycles/instruction.exs
```
...
mix run research/optimizer_lifecycles/ensemble.exs
```
...
mix run research/optimizer_lifecycles/simba.exs
```

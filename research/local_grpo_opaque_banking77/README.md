...
mix run research/local_grpo_opaque_banking77/run.exs
```
...
```sh
export IMP_GRPO_OPAQUE_TREATMENT_CONFIG="$PWD/research/local_grpo_opaque_banking77/usefulness-v1-treatment.json"
...
IMP_GRPO_OPAQUE_PREFLIGHT_ONLY=1 mix run research/local_grpo_opaque_banking77/run.exs
...
```sh
export IMP_GRPO_OPAQUE_TREATMENT_CONFIG="$PWD/research/local_grpo_opaque_banking77/semantic-v1-treatment.json"
export IMP_BANKING77_DATA="$PWD/benchmarks/data/grpo-usefulness-banking77-v1.json"
export IMP_GRPO_OPAQUE_OUTPUT=/new/empty/output
mix run research/local_grpo_opaque_banking77/run.exs
```
...
```sh
export IMP_GRPO_OPAQUE_TREATMENT_CONFIG="$PWD/research/local_grpo_opaque_banking77/trec-semantic-v1-treatment.json"

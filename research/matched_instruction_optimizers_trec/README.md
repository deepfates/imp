...
```sh
mix run -e 'Code.require_file("research/matched_instruction_optimizers_trec/contract.exs"); IO.puts(Jason.encode!(MatchedInstructionOptimizersTREC.Contract.plan!("research/matched_instruction_optimizers_trec/contract.json"), pretty: true))'
```
...
. ../.env
set +a
python3 research/matched_instruction_optimizers_trec/run_paired.py
```

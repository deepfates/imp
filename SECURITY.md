...
DSEx has not published its first stable release. Security fixes currently land
...
Use GitHub's private vulnerability reporting for the DSEx repository. Include
the affected version or commit, impact, reproduction steps, and any proposed
mitigation.

DSEx handles model credentials, tool execution, external MCP and retrieval

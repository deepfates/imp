...
| RAG and multi-hop RAG | [Learning Path: Retrieve Context Deliberately](../LEARNING_PATH.md#6-retrieve-context-deliberately) with `Imp.rag/3` and `hops:` | `mix test test/public_surface_test.exs test/integration/local_service_e2e_test.exs` | Supported local and integration example |
...
| Program of Thought and CodeAct | [Learning Path: sandboxed programs](../LEARNING_PATH.md#7-when-the-input-outgrows-the-prompt-give-the-model-a-sandbox) with `Imp.program_of_thought/2` and `Imp.code_act/3` | `mix test test/program_of_thought_fidelity_test.exs` | Supported sandboxed-code example |
...
| Streaming and async work | [Learning Path: Inspect Runtime Behavior](../LEARNING_PATH.md#9-inspect-runtime-behavior) and `Imp.Streaming` | `mix test test/runtime_async_stream_cache_test.exs test/req_llm_client_test.exs` | Supported runtime APIs |
...
| Financial analysis | Typed programs, schemas, tools, and evaluation in the [Learning Path](../LEARNING_PATH.md) | `mix test test/schema_constraints_test.exs test/metric_contract_test.exs` | Intentional omission of domain-specific financial advice or decisioning |
| Games and code examples | [Learning Path: sandboxed programs](../LEARNING_PATH.md#7-when-the-input-outgrows-the-prompt-give-the-model-a-sandbox) and the sandboxed `Imp.code_act/3` path | `mix test test/program_of_thought_fidelity_test.exs` | Supported code-control primitive; no game engine abstraction |

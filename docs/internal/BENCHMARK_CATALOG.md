...
This catalog asks whether Imp is sampling the right task families from the DSPy
literature, docs, and examples. It is a research map, not a product release
gate. Broad comparative statements are scoped in `benchmarks/claims.json`.

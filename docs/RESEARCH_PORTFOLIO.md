# Capacity-First Research Portfolio

This document is generated in part from
`benchmarks/research_portfolio.json`. The registry defines the capability each
research lane must demonstrate before Imp makes an effectiveness or parity
claim. It complements rather than replaces the authority, feature coverage,
reproduction, and release ledgers.

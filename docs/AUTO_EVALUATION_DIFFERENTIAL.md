...
`mix dsex.benchmark.auto_evaluation_contract` runs a provider-free behavioral differential for `DSEx.Evaluate.SemanticF1` and `DSEx.Evaluate.CompleteAndGrounded`.
...
```sh
mix dsex.benchmark.auto_evaluation_contract --out benchmarks/results/auto-evaluation-differential-v1.json
mix dsex.benchmark.auto_evaluation_contract --validate benchmarks/results/auto-evaluation-differential-v1.json
```

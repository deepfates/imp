...
```sh
mix imp.benchmark.auto_evaluation_contract --out benchmarks/results/auto-evaluation-differential-v1.json
mix imp.benchmark.auto_evaluation_contract --validate benchmarks/results/auto-evaluation-differential-v1.json
```

...
| Color/classification | DSPy public dataset lineage includes simple Colors-style classification. | Loader exists; optimizer-lift artifact includes a passing natural classification lane. | Dataset contract tests, `mix benchmark.optimizer_lift.check` | Add cheap matched smoke when classification becomes a standalone release claim. |

...
| Financial analysis | Typed programs, schemas, tools, and evaluation in [Getting started](../getting-started/index.md) | `mix test test/schema_constraints_test.exs test/metric_contract_test.exs` | Intentional omission of domain-specific financial advice or decisioning |

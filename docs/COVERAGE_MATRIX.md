...
| Streaming | Implemented | `DSEx.Streaming`, `DSEx.Clients.HTTPLM.stream/3` | `test/provider_streaming_test.exs`, `test/completion_surface_test.exs` | Live provider streaming test | `docs/API_GUIDE.md`, `docs/PRODUCTION_OPERATIONS.md`, `docs/ARCHITECTURE.md` | Keep enumerable interface; true incremental delivery requires a `stream/4` transport |

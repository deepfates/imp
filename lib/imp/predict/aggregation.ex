defmodule Imp.Predict.Aggregation do
  @moduledoc """
  ...
  when aggregating `%Imp.Prediction{}` values by a named output field. Without
  ...
  ## Example
      ...
      iex> predictions = [
      ...>   Imp.Prediction.new(answer: "Paris"),
      ...>   Imp.Prediction.new(answer: "paris"),
      ...>   Imp.Prediction.new(answer: "Lyon")
      ...> ]
      iex> Imp.Predict.Aggregation.majority(predictions, field: :answer)
      "Paris"
  """
  ...
  @option_schema [
    field: [
      type: {:custom, Imp.FieldSelector, :validate_optional_name, []},
      default: nil
    ],
    normalize: [
  ...
  def majority(predictions, opts \\ []) do
    opts = Imp.Options.validate!(opts, @option_schema, "Imp.Predict.Aggregation.majority/2")
    field = opts[:field]
  ...
  defp value_for(%Imp.Prediction{} = prediction, nil), do: prediction

  defp value_for(%Imp.Prediction{} = prediction, field),

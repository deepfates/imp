defmodule Imp.Optimizer.GEPA.EvaluationCache.Backend do
  @moduledoc """
  Storage contract for per-example GEPA evaluation caches.

  Backends preserve the semantics of `Imp.Optimizer.GEPA.EvaluationCache`:
  ...
  reconstructs a `Imp.Optimizer.GEPA.Result`.

defmodule Imp.Optimizer.GEPA do
  ...
  @option_schema [
    ...
    resume_cache: [type: {:in, [:replay, :drop]}, default: :replay],
  ...
  def new(metric, opts \\ []) do
    ...
    %__MODULE__{
      ...
      cache_identity: opts[:cache_identity],
      resume_cache: opts[:resume_cache],
  ...
  def compile_with_report(%__MODULE__{} = optimizer, program, trainset, devset, opts \\ []) do
    ...
    engine_opts =
      [
        ...
        cache_identity: optimizer.cache_identity,
        resume_cache: optimizer.resume_cache,

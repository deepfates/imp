defmodule Imp.BenchmarkCatalog do
  @moduledoc false
  ...
  @families [
    ...
    %{
      ...
      status: "provider_free_implemented",
      commands: [
        "mix imp.benchmark.fetch --tasks colors,iris,iris_typo,heart_disease --full --out benchmarks/data",
        "mix imp.benchmark.run --colors benchmarks/data/colors-test-0-6.jsonl --iris benchmarks/data/iris-test-0-6.jsonl --iris-typo benchmarks/data/iris_typo-test-0-3.jsonl --heart-disease benchmarks/data/heart_disease-test-0-4.jsonl",
        "mix benchmark.truth.check"
      ],
      next_step:
    ...
    %{
      ...
      source_lineage:
        "Imp-native recursive controller inspired by DSP-style modular inference, distinct from RAG.",
      task_shape:
    ...
    %{
      ...
      status: "provider_free_implemented",
      commands: [
        "mix imp.benchmark.fetch --tasks composition_orchestration --full --out benchmarks/data",
        "mix imp.benchmark.run --composition-orchestration benchmarks/data/composition_orchestration-test-0-3.jsonl",
      ...
      next_step:
        "Extend sampled orchestration to matched Imp/DSPy live-provider comparison once cost and model policy are selected."
    },
    %{
    ...
    %{
      ...
      task_shape:
        "typed content parts -> provider-compatible message blocks -> decoded Imp content",
    ...
    %{
      ...
      next_step:
        "Run fresh paid/source-checkout campaigns to populate real Imp-vs-DSPy GEPA rows before making dominance claims."
    },
    %{
    ...
    %{
      ...
      commands: [
        "mix imp.benchmark.fetch --tasks iris,iris_typo,heart_disease --full --out benchmarks/data",
        "mix imp.benchmark.run --iris benchmarks/data/iris-test-0-6.jsonl --iris-typo benchmarks/data/iris_typo-test-0-3.jsonl --heart-disease benchmarks/data/heart_disease-test-0-4.jsonl"
      ],
      next_step:
    ...
    %{
      ...
      commands: ["mix imp.benchmark.gepa_dataset", "mix imp.benchmark.gepa_campaign"],
      next_step:
    ...
    %{
      ...
      status: "provider_free_implemented",
      commands: [
        "mix imp.benchmark.fetch --tasks ifbench_instruction_following --full --out benchmarks/data",
        "mix imp.benchmark.run --ifbench-instruction-following benchmarks/data/ifbench_instruction_following-test-0-3.jsonl",
        "mix benchmark.truth.check"
      ],
      next_step:
    ...
    %{
      ...
      status: "provider_free_implemented",
      commands: [
        "mix imp.benchmark.fetch --tasks hard_math --full --out benchmarks/data",
        "mix imp.benchmark.run --hard-math benchmarks/data/hard_math-test-0-3.jsonl",
        "mix benchmark.truth.check"
      ],
      next_step:
    ...
    %{
      ...
      status: "deferred",
      commands: [],
      next_step: "Do not block production unless Imp claims long-form writing optimization."
    },
    %{

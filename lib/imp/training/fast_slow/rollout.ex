defmodule Imp.Training.FastSlow.Rollout do
  ...
  @doc false
  def from_cached!(%Imp.Training.FastSlow.CachedTrajectory{} = cached, slot, state)
      when is_map(slot) do
...
defmodule Imp.Training.FastSlow.AdvantageGroup do
  @moduledoc "Question-level rollout group with normalized training advantages."

  alias Imp.Training.FastSlow.{Config, Rollout}

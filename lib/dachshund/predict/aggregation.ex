defmodule Dachshund.Predict.Aggregation do
  ...
  defp value_for(%Dachshund.Prediction{} = prediction, nil), do: prediction

  defp value_for(%Dachshund.Prediction{} = prediction, field),
    do: Dachshund.Prediction.get(prediction, field)

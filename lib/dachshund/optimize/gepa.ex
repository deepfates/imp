defmodule Dachshund.Optimize.GEPA do
  @moduledoc """
  Pareto-aware reflective optimizer for arbitrary text artifacts.

  This module builds on `Dachshund.Optimize.Anything` and adds GEPA-style mechanics:
  ...
  alias Dachshund.Optimize.Anything.Artifact
  ...
  defp propose_reflection(lm, %Artifact{} = artifact, asi, generation) do
    ...
    case Dachshund.LM.generate(lm, messages, []) do

defmodule DSEx.BenchmarkTruth.OptimizeAnything.Artifact do
  @moduledoc false
  ...
  def build(rows, opts \\ []) do
    ...
    %{
      ...
      "runner" => "dsex-optimize-anything-replication",
      "generated_at" =>
  ...
  def full_artifact?(artifact) when is_map(artifact) do
    ...
    map_value(artifact, "schema_version") == @schema_version and
      map_value(artifact, "runner") == "dsex-optimize-anything-replication" and

defmodule DSEx.Optimizer.GEPA.Proposal do
  @moduledoc false
  ...
  def dump(%Batch{} = batch, dump_result) when is_function(dump_result, 1) do
    payload = %{
      ...
      "deferred_stop_reason" => DSEx.Optimizer.Report.json_safe(batch.deferred_stop_reason)
    }
  ...
  defp dump_context(%Context{} = context, dump_result) do
    %{
      ...
      "components" => DSEx.Optimizer.Report.json_safe(context.components),

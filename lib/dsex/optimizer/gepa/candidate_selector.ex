defmodule DSEx.Optimizer.GEPA.CandidateSelector do
  @moduledoc """
  ...
  alias DSEx.Optimizer.GEPA.Engine
  ...
  defmodule Pareto do
    @moduledoc false
    @behaviour DSEx.Optimizer.GEPA.CandidateSelector
  ...
  defmodule TopKPareto do
    ...
    alias DSEx.Optimizer.GEPA.{Engine, Frontier, Pareto}

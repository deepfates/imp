defmodule DSEx.Optimizer.GEPA.EvaluationCache.Disk do
  @moduledoc """
  Durable, content-addressed GEPA evaluation cache.

  Entries live below `run_dir/evaluation_cache/v1`. Candidate and example
  content is encoded through `DSEx.Optimizer.Report`, canonicalized as JSON,
  ...
  alias DSEx.Optimizer.GEPA.{Candidate, EvaluationCache, Result}
  alias DSEx.Optimizer.GEPA.EvaluationCache.Codec
  alias DSEx.Optimizer.Report

  @artifact_type "dsex_gepa_evaluation_cache_entry"
  @schema_version 1

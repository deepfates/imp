defmodule Mix.Tasks.Imp.Benchmark.InstructionOptimizerCampaign do
  @moduledoc """
  Run a resumable, cost-capped AIME preflight for Imp instruction optimizers.

      mix imp.benchmark.instruction_optimizer_campaign \
  ...
  @shortdoc "Run the cost-capped Imp instruction-optimizer preflight"
  ...
  def run(args) do
    ...
    result =
      Imp.BenchmarkTruth.InstructionOptimizerCampaign.run(

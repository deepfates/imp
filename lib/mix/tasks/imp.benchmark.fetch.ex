defmodule Mix.Tasks.Imp.Benchmark.Fetch do
  @moduledoc """
  Fetch canonical benchmark samples.
      ...
      mix imp.benchmark.fetch --tasks retrieval_qa,claim_verification --full --out benchmarks/data
      mix imp.benchmark.fetch --tasks composition_orchestration --full --out benchmarks/data
      mix imp.benchmark.fetch --tasks ifbench_instruction_following,hard_math --full --out benchmarks/data
      mix imp.benchmark.fetch --tasks gsm8k,hotpotqa --full --out benchmarks/data
  """

  use Mix.Task

  @shortdoc "Fetch canonical Imp benchmark truth datasets"

defmodule Mix.Tasks.Dsex.ResearchPortfolio do
  ...
  def run(args) do
    ...
    portfolio = DSEx.ResearchPortfolio.load!(portfolio_path, claims_path: claims_path)
    current = File.read!(doc_path)

    expected =
      DSEx.ResearchPortfolio.replace_summary!(current, DSEx.ResearchPortfolio.render(portfolio))

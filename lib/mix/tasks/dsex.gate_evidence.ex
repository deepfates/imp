defmodule Mix.Tasks.Dsex.GateEvidence do
  @moduledoc """
  Run a source-checkout gate and write a dashboard-consumable evidence artifact.

      mix dsex.gate_evidence --gate product_package --mix-task package.check

  This task is intentionally outside the packaged DSEx API. It exists so release

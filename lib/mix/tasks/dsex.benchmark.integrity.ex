defmodule Mix.Tasks.Dsex.Benchmark.Integrity do
  @moduledoc """
  Check normalized benchmark JSONL files for data-integrity issues.

      mix dsex.benchmark.integrity --gsm8k benchmarks/data/gsm8k-test-0-1319.jsonl \\
  ...
  def run(args) do
    ...
    result =
      DSEx.BenchmarkTruth.integrity(tasks,

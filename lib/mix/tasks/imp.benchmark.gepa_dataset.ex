defmodule Mix.Tasks.Imp.Benchmark.GepaDataset do
  @moduledoc """
  Export GEPA artifact benchmark splits into Imp GEPA campaign dataset format.
  ...
  per-family JSONL files consumed by `mix imp.benchmark.gepa_campaign`.
  """

  use Mix.Task

  @shortdoc "Export GEPA artifact family splits for Imp campaigns"

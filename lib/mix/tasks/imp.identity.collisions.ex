defmodule Mix.Tasks.Imp.Identity.Collisions do
  @moduledoc """
  Check derived package forms against exact public registry endpoints.

      mix imp.identity.collisions
      mix imp.identity.collisions --source hex --source npm,pypi --delay-ms 1250
      mix imp.identity.collisions --source all --refresh
  """

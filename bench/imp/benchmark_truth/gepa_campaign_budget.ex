defmodule Imp.BenchmarkTruth.GepaCampaignBudget do
  @moduledoc false

  use GenServer

  alias Imp.BenchmarkTruth.GepaCampaignBudgetedLM
...
defmodule Imp.BenchmarkTruth.GepaCampaignBudgetedLM do
  @moduledoc false
  ...
  def generate(%__MODULE__{} = lm, messages, opts) do
    case Imp.BenchmarkTruth.GepaCampaignBudget.reserve(lm.budget, lm.shard, messages, opts) do
      {:ok, reservation} ->
        ...
        after
          Imp.BenchmarkTruth.GepaCampaignBudget.release(lm.budget, reservation)
        end

defmodule Imp.BenchmarkTruth.Fetcher do
  @moduledoc false
  ...
  @local_specs %{
    ...
    "heart_disease" => %{
      task: "heart_disease",
      dataset: "imp/local-heart-disease",
      config: "risk-smoke",
      split: "test",
      input_keys: ["features"],
      label_key: "label",
    ...
    "retrieval_qa" => %{
      task: "retrieval_qa",
      dataset: "imp/local-retrieval-qa",
      config: "mini-corpus",
      split: "test",
      input_keys: ["question"],
      label_key: "answer",
    ...
    "claim_verification" => %{
      ...
      dataset: "imp/local-claim-verification",
      config: "mini-corpus",
      split: "test",
      input_keys: ["claim"],
      label_key: "label",
    ...
    "composition_orchestration" => %{
      ...
      dataset: "imp/local-composition-orchestration",
      config: "qa-mini",
      split: "test",
      input_keys: ["question"],
      label_key: "answer",

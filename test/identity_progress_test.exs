defmodule Imp.IdentityProgressTest do
  use ExUnit.Case, async: true

  alias Imp.{IdentityCheckpoint, IdentityEnrichment, IdentityProgress}
  ...
  defp tmp_root do
    root =
      Path.join(System.tmp_dir!(), "imp-identity-progress-#{System.unique_integer([:positive])}")
